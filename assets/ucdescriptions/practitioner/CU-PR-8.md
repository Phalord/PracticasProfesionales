...
**Precondiciones:**  
Pre-1. El *Practicante* debe tener las 200hrs de servicio reportadas en los **`REPORT`**.
...
**Flujo Normal:**
  ...
  9. El *SPP* guarda el **`SELF APPRAISAL`** en la Base de Datos y muestra un [`Dialog_Success`][DLSU]. <a href="#ex_2">EX-2</a>
...
**Excepciones:**
   1. <a id="ex_1" class="disabled"><i>Error al cargar archivo</i></a>
      1. El *SPP* carga el archivo del **`SELF APPRAISAL`** y muestra un [`Dialog_Error`][DLER].
   ...
   2. <a id="ex_2" class="disabled"><i>Error al conectar con Base de Datos</i></a>
      1. El *SPP* guarda el **`SELF APPRAISAL`** en la Base de Datos y muestra un [`Dialog_ConnectionError`][DLCE] con el botón "Aceptar".
      2. El *Practicante* da clic en el botón "Aceptar".
