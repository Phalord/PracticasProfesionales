...
**Flujo Normal:**
  ...
  9. El *SPP* guarda el `SCHOOL TIMETABLE` en la Base de Datos y muestra un `Dialog_Success`. EX-2
...
**Excepciones:**
   ...
   2. *Error al conectar con Base de Datos*
      1. El *SPP* no puede conectarse con la Base de Datos para guardar el `SCHOOL TIMETABLE`.
