...
**Flujo Normal:**
  ...
  4. El *Practicante* busca su **`MONTHLY REPORT`** en el seleccionador de archivos, lo selecciona y da clic en "Cargar". <a href="fa_2">FA-2</a>
  5. El *SPP* carga el archivo del **`MONTHLY REPORT`** y muestra el nombre del archivo. <a href="ex_1">EX-1</a>
  ...
  9. El *SPP* guarda el **`MONTHLY REPORT`** en la Base de Datos y muestra un [`Dialog_Success`][DLSU]. <a href="#ex_2">EX-2</a>
...
**Excepciones:**
   1. <a id="ex_1" class="disabled"><i>Error al cargar archivo</i></a>
      1. El *SPP* carga el archivo del **`MONTHLY REPORT`** y muestra un [`Dialog_Error`][DLER].
   ...
   2. <a id="ex_2" class="disabled"><i>Error al conectar con Base de Datos</i></a>
      1. El *SPP* guarda el **`MONTHLY REPORT`** en la Base de Datos y muestra un [`Dialog_ConnectionError`][DLCE] con el botón "Aceptar".
      2. El *Practicante* da clic en el botón "Aceptar".
