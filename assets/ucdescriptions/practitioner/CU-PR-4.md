...
**Disparador:**  
El *Practicante* da clic al botón "Añadir Reporte Parcial" en la interfaz `View_UploadDocumentation`.
...
**Flujo Normal:**
  ...
  9. El *SPP* guarda el `PARTIAL REPORT` en la Base de Datos y muestra un `Dialog_Succes`. EX-2
